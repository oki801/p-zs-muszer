...
//#include <Adafruit_GPS.h> //Using AdaFruit GPS lib csak hardverrel
#include <TinyGPS.h> 
#include <OneWire.h>
...
Adafruit_GPS GPS(&ss);   //hardver serial portot használom
...
u8g2.setFont(u8g2_font_profont17_tr);
    ...
    //u8g2.setFont(u8g2_font_helvB10_te);// ez a jó
    u8g2.setFont(u8g2_font_profont17_tr);
