...
#define ONE_WIRE_BUS 39 // ds külső szenzor port 
...
Adafruit_GPS GPS(&Serial1);   //hardver serial portot használom
...
u8g2.drawStr(62,12,"k");
u8g2.drawStr(62,22,"m"); 
u8g2.drawStr(62,34,"h"); 
}
...
u8g2.setCursor(2, 32);
u8g2.print( String((int)GPS.speed)); // teszt miatt a +100
